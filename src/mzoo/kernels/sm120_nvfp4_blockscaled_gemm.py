# source: tile-ai/tilelang@v0.1.14 examples/gemm_sm120/sm120_nvfp4_blockscaled_gemm.py (copied as-is)
...
# mzoo workaround: mma_block_scale.h gates on SM120A only; lets sm121 (GB10) emit the MMA. see tickets/0001-tilelang-issues.md
